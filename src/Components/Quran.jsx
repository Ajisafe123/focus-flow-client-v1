  ...
  const fetchPageData = useCallback(async (page) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/quran/page/${page}?${params}`,
        {
          method: "GET",
          headers: headers,
        }
    ...
    return (
      <div className="flex justify-center items-center py-32">
        <div className="relative">
          ...
          <div className="animate-spin rounded-full h-16 w-16 border-t-4 border-emerald-500 absolute top-0"></div>
        </div>
      </div>
    );
  }
  ...
  return (
    <main className="max-w-5xl mx-auto pt-4 pb-32 relative">
      ...
      <div className="text-center mb-1 p-6 sm:p-8 border-b border-gray-200 relative">
        <h2
          className="aref-ruqaa-regular text-4xl sm:text-5xl font-bold text-emerald-900 mb-2 inline-block px-4 py-2"
