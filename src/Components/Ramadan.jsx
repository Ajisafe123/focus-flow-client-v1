          ...
          <details className="group list-none">
            <summary className="cursor-pointer flex flex-col items-center justify-center">
              <div className="flex items-center gap-3 justify-center mb-5">
                <Moon className="w-10 h-10 md:w-14 md:h-14 transition-transform group-open:scale-110" />
                <Star className="w-10 h-10 md:w-14 md:h-14 transition-transform group-open:scale-110" />
