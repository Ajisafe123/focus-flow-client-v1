...
import { X, Package, DollarSign, Image as ImageIcon, Check } from "lucide-react";

const ProductModal = ({ show, onClose, onSave, product = null }) => {
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g., Islamic Prayer Mat"
                        />
                    </div>
