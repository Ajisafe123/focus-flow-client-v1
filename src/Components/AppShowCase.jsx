  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-br from-gray-50 via-white to-emerald-50 overflow-hidden">
      <header className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-8 py-16 sm:py-20">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
            <div className="flex flex-col items-center lg:items-start gap-6 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-4">
                <button className="group px-8 py-4 bg-white text-emerald-900 rounded-2xl font-bold shadow-2xl hover:shadow-emerald-900/20 hover:scale-105 transition-all duration-300 flex items-center gap-3 justify-center">
                  <svg
                    className="w-6 h-6"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                ...
                <button className="group px-8 py-4 bg-emerald-900/90 backdrop-blur text-white rounded-2xl font-bold shadow-2xl hover:bg-emerald-950 hover:scale-105 transition-all duration-300 flex items-center gap-3 justify-center border-2 border-white/20">
                  <svg
                    className="w-6 h-6"
                    fill="currentColor"
                    viewBox="0 0 24 24"
      ...
      <section className="max-w-7xl mx-auto px-8 space-y-32 pt-24 pb-16">
        {content.map((item, index) => {
          const rotationStyle =
            index % 2 !== 0
              ? {
                  transform:
                    "perspective(1200px) rotateY(-25deg) rotateX(5deg)",
                }
              : {
                  transform: "perspective(1200px) rotateY(25deg) rotateX(5deg)",
                };

          const rightButtons = index % 2 !== 0 ? "hidden" : "block";
          const leftButtons = index % 2 !== 0 ? "block" : "hidden";
          ...
          return (
            ...
            >
              ...
              >
                <div
                  className="relative w-80 h-[650px] transition-all duration-700 hover:scale-105"
                  style={{
                    transformStyle: "preserve-3d",
                    ...rotationStyle,
                  }}
                >
                  <div className="relative w-full h-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-[3.5rem] p-3 shadow-2xl">
                    <div className="absolute top-3 left-1/2 -translate-x-1/2 w-32 h-9 bg-black rounded-full z-10 shadow-inner flex items-center justify-center gap-3">
                    ...
                    <div className="w-full h-full bg-white rounded-[3rem] overflow-hidden relative shadow-inner">
                      <img
                        ...
                        onError={(e) => {
                          ...
                          e.target.parentElement.innerHTML = `
                            <div class="w-full h-full bg-gradient-to-br ${item.color} flex items-center justify-center text-white p-8">
                      ...
                      <div className="absolute top-0 left-0 w-32 h-32 bg-white/30 rounded-full blur-3xl pointer-events-none"></div>
                    </div>

                    <div
                      className={`absolute -right-1 top-32 w-1 h-20 bg-gradient-to-b from-gray-700 to-gray-900 rounded-l-full ${rightButtons}`}
                    ></div>
                    <div
                      className={`absolute -left-1 top-28 w-1 h-10 bg-gradient-to-b from-gray-700 to-gray-900 rounded-r-full ${leftButtons}`}
                    ></div>
                    <div
                      className={`absolute -left-1 top-44 w-1 h-16 bg-gradient-to-b from-gray-700 to-gray-900 rounded-r-full ${leftButtons}`}
                    ></div>
                    <div
                      className={`absolute -left-1 top-64 w-1 h-16 bg-gradient-to-b from-gray-700 to-gray-900 rounded-r-full ${leftButtons}`}
                    ></div>

                    <div className="absolute inset-3 rounded-[3rem] border border-white/10 pointer-events-none"></div>
                  </div>
              ...
              >
                ...
                <h3
                  className={`text-2xl font-semibold bg-gradient-to-r ${item.color} bg-clip-text text-transparent`}
                >
                  {item.subtitle}
                </h3>
                ...
                <div className="flex gap-4 pt-4">
                  <button
                    className={`px-6 py-3 bg-gradient-to-r ${item.color} text-white rounded-full font-semibold shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 text-base`}
                  >
                    Get Started
                  </button>
                  <button className="px-6 py-3 bg-white text-gray-800 rounded-full font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 border border-gray-200 text-base">
                    Read More
                  </button>
                </div>
              </div>
      ...
      <div className="mt-24 mx-auto max-w-7xl px-8 pb-16">
        <div className="relative overflow-hidden py-16 rounded-3xl text-center text-white space-y-8 px-8 bg-gradient-to-br from-emerald-600 via-teal-700 to-emerald-800 shadow-2xl">
          <div className="absolute inset-0 opacity-10">
          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8">
              <button className="px-10 py-4 bg-white text-emerald-900 rounded-full font-bold text-lg hover:bg-emerald-50 transition-all hover:scale-105 shadow-xl">
                Download for iOS
              </button>
              <button className="px-10 py-4 bg-emerald-900 text-white rounded-full font-bold text-lg hover:bg-emerald-950 transition-all hover:scale-105 shadow-xl border-2 border-white/30">
